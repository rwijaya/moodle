...
$id   = required_param('reply', 0, PARAM_INT);

$PAGE->set_url('/mod/forum/role_playing.php', array(
    'id' => $id,
));
...
if (!empty($forum)) {      // User is starting a new discussion in a forum
    ...
    if (!$cm->visible and !has_capability('moodle/forum:roleplaying', $coursecontext)) {
