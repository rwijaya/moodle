...
$string['explain_site_dateformat'] = 'You can choose to see dates in either day-month-year, month-day-year or year-month-day format for the whole site. If you choose "default", then the format will be automatically chosen according to the language you use in the site. This setting can be overridden by user preferences.';
...
$string['pref_dateformat'] = 'Date display format';
