                ...
                button_create.on('click',function(e) {
                    ...
                    if (!this.mkdir_dialog) {
                        ...
                        node.all('.fp-dlg-butcancel').on('click', function(e){
                            ...
                            this.mkdir_dialog.get('boundingBox').detach('key');
                        }, this);
                        node.all('.fp-dlg-curpath').set('id', 'fm-curpath-'+this.client_id);
                        this.trapFocus(this.mkdir_dialog);
                    }
        ...
        show_confirm_dialog: function(dialog_options) {
            ...
            if (!this.confirm_dlg) {
                ...
                var handle_confirm = function(ev) {
                    ...
                    this.confirm_dlg.get('boundingBox').detach('key');
                    if (dlgopt.callback) {
                ...
                this.trapFocus(this.confirm_dlg);
            }
