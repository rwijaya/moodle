...
var DIALOGUE_NAME = 'Moodle dialogue',
    ...
    CAN_RECEIVE_FOCUS_SELECTOR = 'input:not([type="hidden"]), a[href], button, textarea, select ';
...
Y.extend(DIALOGUE, Y.Panel, {
    ...
    show : function() {
        ...
        this.callback = this.keyDelegation();
    },
    /**
     * Override the hide method to detach key delegate on the dialogue.
     *
     * @method hide
     * @return void
     */
    hide : function() {
        var result = null,
            bb = this.get('boundingBox');
        bb.on('blur', function(e) {
            this.detach('key');
        }, this);

        result = DIALOGUE.superclass.hide.call(this);
        return result;
    },
    /**
