                ...
                'users' => new external_multiple_structure(
                    new external_single_structure(
                        array(
                            ...
                            'dateformat'  => new external_value(PARAM_TEXT, 'Dateformat options to display the date', VALUE_OPTIONAL),
                            'timeformat'  => new external_value(PARAM_TEXT, 'Timeformat 12 or 24 hours', VALUE_OPTIONAL),
