...
abstract class format_section_renderer_base extends plugin_renderer_base {
    ...
    public function print_single_section_page($course, $sections, $mods, $modnames, $modnamesused, $displaysection) {
        ...
        $sectiontitle = '';
        $sectiontitle .= html_writer::start_tag('div', array('class' => 'section-navigation header'));
        ...
        $sectiontitle .= html_writer::tag('div', $OUTPUT->heading(get_section_name($course, $displaysection)), array('class' => $titleattr));
